...
from app.db.base import get_citizen, update_money, set_user_status
from app.db.engine import DB_PATH
from app.shared.data.stock_data import STOCKS, generate_dynamic_news, calculate_next_price
